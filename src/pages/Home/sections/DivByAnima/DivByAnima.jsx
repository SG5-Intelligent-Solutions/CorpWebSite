...
export const DivByAnima = () => {
  ...
  return (
    <Card className="w-full max-h-[40rem] max-w-[900px] h-auto py-6 px-6 bg-[#15182005] rounded-[10px] border-[5px] border-solid border-[#a1c0ff] backdrop-blur-[25px] backdrop-brightness-[100%] [-webkit-backdrop-filter:blur(25px)_brightness(100%)]">
