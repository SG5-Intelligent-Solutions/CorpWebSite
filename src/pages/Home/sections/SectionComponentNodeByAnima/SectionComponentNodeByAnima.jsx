...
export const SectionComponentNodeByAnima = () => {
  ...
  return (
    <Card className="relative max-h-[40rem] w-full max-w-[900px] bg-[#15182005] rounded-[10px] border-[5px] border-solid border-[#a1c0ff] backdrop-blur-[25px] backdrop-brightness-[100%] [-webkit-backdrop-filter:blur(25px)_brightness(100%)]">
